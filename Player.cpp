...
Player::Player(float x, float y, sf::Texture& texture_sheet)
{
	...
	this->initAnimations();
	this->weapon = new Sword(1, 2, 5, 50, 20, "Resources/Images/Sprites/Player/sword.png");
	this->initInventory();
}
...
void Player::addItem(Item* item)
{
    ...
    {
        std::cout << "ITEM MASUK KE INVENTORY PLAYER!" << "\n";
    }
    else
    {
        std::cout << "INVENTORY PENUH!" << "\n";
        // Kurang= penuh dikembalikan ke tanah (tapi nanti saja logikanya)
    }
}
