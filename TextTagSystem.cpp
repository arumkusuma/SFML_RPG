...
void TextTagSystem::initTagTemplates()
{
	...
	this->tagTemplates[HEAL_TAG] = new TextTag(this->font, "", 100.f, 100.f, 0.f, -1.f, sf::Color::Green, 25, 100.f, true, 200.f, 200.f, 2);
	this->tagTemplates[POSITIVE_TAG] = new TextTag(this->font, "", 100.f, 100.f, 0.f, -1.f, sf::Color::Yellow, 25, 100.f, true, 200.f, 200.f, 2);
}
