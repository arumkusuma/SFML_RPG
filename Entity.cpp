...
{
   sf::Vector2f center_this = this->getSpriteCenter();
    sf::Vector2f center_target = entity.getSpriteCenter();

    float dx = center_this.x - center_target.x;
    float dy = center_this.y - center_target.y;
